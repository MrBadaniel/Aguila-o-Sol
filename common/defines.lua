...
NCharacter = {
	...
	PORTRAIT_OLD_AGE_THRESHOLD = 59,				-- Old age switch for character portraits
	...
	EARLY_PORTRAIT_AND_UNIT_BEFORE_YEAR = 3100,		-- Before this date, early versions of Units and Portraits will be used if available
	LATE_PORTRAIT_AND_UNIT_AFTER_YEAR = 3200,		-- After this date, late versions of Units and Portraits will be used if available
